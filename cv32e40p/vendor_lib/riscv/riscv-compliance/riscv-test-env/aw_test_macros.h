...
#define SWSIG32( testnum, addr, testreg ) \
    la  x28, test_res; \
    sw testreg, (addr)(x28); \

#define SWSIG64( testnum, addr, testreg, testreg1 ) \
    la  x30, test_res; \
    sw testreg, (addr)(x30); \
    la  x31, test_res; \
    sw testreg1, (addr+4)(x31); \

#
# Address = base+(testnum<<2)
# sw testreg, (testnum<<2)(basereg)
#
#define TEST_CASE( testnum, addr, testreg, correctval, code... ) \
test_ ## testnum: \
    code; \
...
#define TEST_CASE64_OO( testnum, addr, testreg, testreg1,correctval, code... ) \
test_ ## testnum: \
    code; \
    li  x29, MASK_XLEN(correctval); \
    li  TESTNUM, testnum; \
        SWSIG64(testnum, addr, testreg,testreg1); \
    bne testreg, x29, fail;

#define TEST_CASE64( testnum, addr, testreg, testreg1,correctval, code... ) \
test_ ## testnum: \
    code; \
    li  x29, MASK_XLEN(correctval); \
    li  TESTNUM, testnum; \
...
#define TEST_IMM_OP( testnum, inst, result, val1, imm, addr) \
    TEST_CASE( testnum, addr, x30, result, \
      li  x1, MASK_XLEN(val1); \
      inst x30, x1, SEXT_IMM(imm); \
    )
#define TEST_IMM_OP64_OI( testnum, inst, result, val1, val2, imm, addr) \
    TEST_CASE( testnum, addr, x30, result, \
      li  x3, MASK_XLEN(val2); \
      li  x2, MASK_XLEN(val1); \
      inst x30, x2, SEXT_IMM(imm); \
    )
#define TEST_IMM_OP_FSRI( testnum, inst, result, val1, val2, imm, addr) \
    TEST_CASE( testnum, addr, x30, result, \
      li  x3, MASK_XLEN(val2); \
      li  x2, MASK_XLEN(val1); \
      inst x30, x2,x3, SEXT_IMM(imm); \
    )
...
#define TEST_R_OP( testnum, inst, result, val1, addr) \
    TEST_CASE( testnum, addr, x30, result, \
      li  x2, val1; \
      inst x30, x2; \
    )
...
#-----------------------------------------------------------------------
# Tests for an instruction with register-register-register operands
#-----------------------------------------------------------------------

#define TEST_RRR_OP( testnum, inst, result, val2, val1, val3, addr) \
    TEST_CASE( testnum, addr, x14, result, \
...
#define TEST_RR_OP( testnum, inst, result, val1, val2, addr) \
    TEST_CASE( testnum, addr, x30, result, \
      li  x1, MASK_XLEN(val1); \
      li  x2, MASK_XLEN(val2); \
      inst x30, x1, x2; \
    )
#define TEST_RR_OP64_OI( testnum, inst, result, val1, val2, val3, addr) \
    TEST_CASE( testnum, addr, x30, result, \
      li  x2, MASK_XLEN(val1); \
      li  x3, MASK_XLEN(val2); \
      li  x4, MASK_XLEN(val3); \
      inst x30, x2, x4; \
    )
#define TEST_RR_OP_FSR( testnum, inst, result, val1, val2, val3, addr) \
    TEST_CASE( testnum, addr, x30, result, \
      li  x2, MASK_XLEN(val1); \
      li  x3, MASK_XLEN(val2); \
      li  x4, MASK_XLEN(val3); \
...
#define TEST_RR_OP64_OO( testnum, inst, result, val1, val2, addr ) \
    TEST_CASE64_OO( testnum, addr, x20,x21, result, \
      li  x1, MASK_XLEN(val1); \
      li  x2, MASK_XLEN(val2); \
      inst x20, x1, x2; \
    )

#define TEST_RR_OP64_RS1_RD( testnum, inst, result, val1, val2, val3, addr) \
    TEST_CASE64( testnum, addr, x20, x21, result, \
      li  x4, MASK_XLEN(val3); \
      li  x3, MASK_XLEN(val2); \
      li  x2, MASK_XLEN(val1); \
      inst x20, x2, x4; \
...
#define TEST_RR_OP64_IO( testnum, inst, result, val1, val2, val3, val4, addr) \
    TEST_CASE64( testnum, addr, x20, x21, result, \
      li  x5, MASK_XLEN(val4); \
      li  x4, MASK_XLEN(val3); \
      li  x3, MASK_XLEN(val2); \
      li  x2, MASK_XLEN(val1); \
      inst x20, x2, x4; \
