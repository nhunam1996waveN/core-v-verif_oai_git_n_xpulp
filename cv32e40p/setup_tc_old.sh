...
export PATH=$PATH:/11users/quannh41/experiments/riscv-gnu-toolchain-v4/toolchain_risc
#export PATH=$PATH:/11users/quannh41/waveletJSC/wl-toolchain-buildscript-rv32/install/bin
