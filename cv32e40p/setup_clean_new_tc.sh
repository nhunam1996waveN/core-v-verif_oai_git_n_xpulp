...
#export CV_SW_TOOLCHAIN=/11users/nhunam/WORKSPACE/toolchain/wl-toolchain-buildscript_nam/install
...
export PATH=/11users/nhunam/WORKSPACE/toolchain/wl-toolchain-buildscript_nam/install:$PATH
